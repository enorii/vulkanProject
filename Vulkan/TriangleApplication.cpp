...
TriangleApplication::TriangleApplication():
    window(nullptr), isRunning(false), instance(nullptr), debugMessenger(0), surface(0) {
    isRunning = true;
}
...
VKAPI_ATTR VkBool32 VKAPI_CALL TriangleApplication::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData) {
